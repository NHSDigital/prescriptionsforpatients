...
function main() {
  ...
  const pfpApiStack = new PfPApiStack(app, "PfPApiStack", {
    ...
    tc007NhsNumberValue: getConfigFromEnvVar("tc007NhsNumberValue", "not_in_use"),
    tc008NhsNumberValue: getConfigFromEnvVar("tc008NhsNumberValue", "not_in_use"),
    tc009NhsNumberValue: getConfigFromEnvVar("tc009NhsNumberValue", "not_in_use"),
