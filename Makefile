...
download-get-secrets-layer:
	...
	curl -LJ https://github.com/NHSDigital/electronic-prescription-service-get-secrets/releases/download/v1.0.300-alpha/get-secrets-layer.zip -o packages/getSecretLayer/lib/get-secrets-layer.zip
